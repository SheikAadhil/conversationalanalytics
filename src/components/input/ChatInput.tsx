...
export function ChatInput({ onSend, disabled, placeholder = 'Ask Pulse...' }: ChatInputProps) {
    ...
    <div className="px-4 md:px-6 pb-4 pt-1">
      <div className="relative group">
        <motion.div 
          initial={false}
          animate={{ 
            boxShadow: value.trim() ? '0 0 15px rgba(99, 102, 241, 0.06)' : '0 1px 2px rgba(0,0,0,0.04)'
          }}
        ...
        >
          <textarea
            ...
            disabled={disabled}
            rows={1}
            className="flex-1 bg-transparent px-3 py-2 text-[13px] text-text-primary placeholder:text-text-tertiary/60 outline-none resize-none font-medium leading-[1.4] max-h-36 disabled:opacity-50"
